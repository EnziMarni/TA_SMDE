...
<div class="dflex">
            ...
            <div class="position-sticky">
                <div class="collapse d-sm-none d-md-block" id="navbarNav">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::currentRouteName() == 'input-dokumen' ? 'active' : '' }}" id="v-pills-profile-tab" href="{{ route('input-dokumen') }}" role="tab" aria-controls="v-pills-profile" aria-selected="false">Upload Dokumen</a>
                        </li>
                        <li class="nav-item">
    ...
    <div style="width: 70%; height: auto;">
        <!-- Replace canvas with a paragraph for displaying total documents -->
        <p id="totalDocuments" style="font-size: 24px; font-weight: bold;">Total Dokumen: <span id="documentCount">{{ $documentCount }}</span></p>
    </div>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        fetch('{{ route('unapproved-users') }}')
            ...
            .then(data => {
                ...
                unapprovedUsersTableBody.innerHTML = ''; 
