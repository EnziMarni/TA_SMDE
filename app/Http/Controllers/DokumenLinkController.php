...
class DokumenLinkController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'dokumen_file' =>
                'required|file|mimes:pdf,docx,jpeg,png,jpg|max:2048',
        ...
        $fileName = str_replace(
            ' ',
            '_',
            $request->dokumen_file->getClientOriginalName()
        );
    ...
    public function update(Request $request, $id)
    {
        ...
        History::create([
            ...
            'dokumen_file' =>
                $document->status_file == 0 ? $document->dokumen_file : null,
            'dokumen_link' =>
                $document->status_file == 1 ? $document->dokumen_link : null,
            'tags' => $document->tags,
        ...
        $document->dokumen_link =
            $validatedData['dokumen_link'] ?? $document->dokumen_link;
